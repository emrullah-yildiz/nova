...
| feat/tick-013-surface-trim | mouse | T13a: new Surface.Trim node | src/geometry/nodes/Surface.Trim.js, src/nodes/categories/surfaces.js (Surface.Trim entry only), tests/geometry/surface-trim.test.js | — | 2026-06-17 | queued |
