...
| feat/pattern-on-surface-geo | geometry-engineer (mouse) | T04a — TICK-004: Kernel UV remapping, output format, remove Panel.ByPoints, add Panel.Points, rename PanelFrames→PanelPlane, fix VoronoiMesh sample, Vitest + E2E specs | `src/geometry/geo-facade-panels.js`, `src/geometry/geo-voronoi.js`, `src/nodes/categories/patterns.js`, `tests/geometry/geo-facade-panels.test.js`, `tests/e2e/pattern-on-surface.spec.js` | — | 2026-06-05 | **active** |
| feat/pattern-on-surface-registry | core-engineer (neo) | T04c — TICK-004: node-library.js registry: remove Panel.ByPoints, add Panel.Points, register Pattern.PanelPlane (deregister PanelFrames) | `src/core/node-library.js` | `src/core/node-library.js` | 2026-06-05 | **queued** |
