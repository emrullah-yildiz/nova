...
| feat/tick-015-surface-pointatparameter | mouse | T15a: rename Surface.PointAtUV → Surface.PointAtParameter | src/nodes/categories/surfaces.js (PointAtUV→PointAtParameter rename+stub), tests/geometry/surface-pointatparameter.test.js (new), tests/library-reorg.test.js (type ref update) | — | 2026-06-18 | active |
