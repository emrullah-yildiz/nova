...
| feat/learning-screenshots | ui-engineer (switch) | T06a — TICK-006: Identify 20 slot IDs from learning-page.js source; take real Nova canvas screenshots at 1280×800 dark theme; save as public/learning/<slot-id>.png ≤400 KB each; confirm no broken images | `public/learning/*.png` | — | 2026-06-05 | **queued** |
