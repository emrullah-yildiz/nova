...
|---|---|---|---|---|---|---|
| TICK-009 | Select.Faces — per-face hover, selection, and planar face output | 🟡 in-progress | high | 2026-06-07 | geometry, ui | merged to develop — awaiting PM re-test (Bug A + Bug B) |
